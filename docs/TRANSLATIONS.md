...
[Weblate](https://hosted.weblate.org/projects/ecuamaps/) translations of the app and map types are integrated manually on a regular basis.

## Contribute translations directly

Adding and updating translations is easy!
1. Change the translation file you want, e.g. [strings.txt](../data/strings/strings.txt) ([raw text version](https://raw.githubusercontent.com/ecuamaps/ecuamaps/master/data/strings/strings.txt))
...
- Website translations: see [website/README.md](https://github.com/ecuamaps/website/blob/master/README.md#translations)
