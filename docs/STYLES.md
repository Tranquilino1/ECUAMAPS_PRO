...
Please check [a list of current styling issues](https://github.com/ecuamaps/ecuamaps/issues?q=is%3Aopen+is%3Aissue+label%3AStyles)
and ["icons wanted" issues](https://github.com/ecuamaps/ecuamaps/issues?q=is%3Aopen+is%3Aissue+label%3AIcons+label%3A%22Good+first+issue%22).

An overview of currently used icons can be found in the [Wiki](https://github.com/ecuamaps/ecuamaps/wiki/Icons).
...
(e.g. `Android/data/app.ecuamaps/files/styles/`).
...
The `tools/unix/generate_drules.sh` script uses a customized version of [Kothic](https://github.com/ecuamaps/kothic)
