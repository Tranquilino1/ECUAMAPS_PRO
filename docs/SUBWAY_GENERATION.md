...
For the subway layer to be available in ECUAMAPS, a `SUBWAY_URL`
parameter ought to be provided to the
[map generator](https://github.com/ecuamaps/ecuamaps/tree/master/tools/python/maps_generator).
Normally you can specify this link https://cdn.ecuamaps.app/subway.json,
...
1.  With the [ECUAMAPS subways](https://github.com/ecuamaps/subways) repository deployed,
