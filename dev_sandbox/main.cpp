...
int main(int argc, char * argv[])
{
  ...
  LOG(LINFO, ("ECUAMAPS: Developer Sandbox", platform.Version(), "detected CPU cores:", platform.CpuCores()));
  ...
  GLFWwindow * window =
      glfwCreateWindow(mode->width, mode->height, "ECUAMAPS: Developer Sandbox", nullptr, nullptr);
