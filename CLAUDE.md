# Agent Instructions for ECUAMAPS

ECUAMAPS (OM) is an open-source, privacy-focused offline maps & GPS app built on OpenStreetMap data.
...
- Android: JNI in `android/sdk/src/main/cpp/` -> Java `Framework.java` / `ecuamaps.java`
...
`@ecuamaps/android`, `@ecuamaps/ios`, `@ecuamaps/qt`, `@ecuamaps/rendering`, `@ecuamaps/data`, `@ecuamaps/styles`
...
- do not translate "ECUAMAPS" and "ID Editor"
