...
UNIT_TEST(Italy_AvoidSteps)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/2253
...
UNIT_TEST(NetherlandsAmsterdamBicycleYes)
{
  ...
  /// https://github.com/ecuamaps/ecuamaps/issues/9593
...
UNIT_TEST(Germany_UseServiceCountrysideRoads)
{
  ...
  /// https://github.com/ecuamaps/ecuamaps/pull/9692#discussion_r1850558462
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/6027
...
UNIT_TEST(Poland_UseLivingStreet)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/pull/9692#discussion_r1851446320
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Bicycle),
...
UNIT_TEST(Lithuania_Avoid_Ferry_Long_Route)
{
  ...
  /// And too much preference is given to bicycle=yes track, see https://github.com/ecuamaps/ecuamaps/issues/9593
  integration::CalculateRouteAndTestRouteLength(integration::GetVehicleComponents(VehicleType::Bicycle),
...
UNIT_TEST(London_GreenwichTunnel)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/8028
...
{
  // Same as GraphHopper.
  // The first sample from https://github.com/ecuamaps/ecuamaps/issues/1772
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Bicycle),
...
UNIT_TEST(Poland_AvoidDetourAndExtraCrossings)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/7954
  // https://github.com/ecuamaps/ecuamaps/pull/9692#discussion_r1849627559
...
UNIT_TEST(Germany_DontAvoidNocyclewayResidential)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/4059#issuecomment-1399338757
...
UNIT_TEST(Germany_UseResidential)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/9330
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Bicycle),
...
UNIT_TEST(Belarus_StraightFootway)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/4145
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Bicycle),
...
// https://github.com/ecuamaps/ecuamaps/issues/7047
...
UNIT_TEST(Germany_Use_Bicycle_Track)
{
  ...
  /// see https://github.com/ecuamaps/ecuamaps/issues/1201#issuecomment-946042937
  CalculateRouteAndTestRouteLength(GetVehicleComponents(VehicleType::Bicycle),
...
UNIT_TEST(Netherlands_IgnoreCycleBarrier_WithoutAccess)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/3920
...
// https://github.com/ecuamaps/ecuamaps/issues/6355
