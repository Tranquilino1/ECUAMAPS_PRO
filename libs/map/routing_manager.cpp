...
void RoutingManager::BuildRoute(uint32_t timeoutSec)
{
  ...
  // https://github.com/ecuamaps/ecuamaps/issues/7939
  // https://github.com/ecuamaps/ecuamaps/issues/9592
  // https://github.com/ecuamaps/ecuamaps/issues/11256
  ...
  // Disabled preview zoom to fix https://github.com/ecuamaps/ecuamaps/issues/5409.
...
void RoutingManager::SetRouter(RouterType type)
{
  ...
  /// @TODO(AB): The proper fix is to not set mFrameworkInitialized=true in Android's ecuamaps.java
