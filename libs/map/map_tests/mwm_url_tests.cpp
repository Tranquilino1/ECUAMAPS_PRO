...
UNIT_TEST(MapApiSmoke)
{
  string urlString =
      "mapswithme://"
      "map?ll=38.970559,-9.419289&ignoreThisParam=Yes&z=17&n=Point%20Name&s=black&backurl=https%3A%2F%2Fecuamaps."
      "app";
  ...
  TEST_EQUAL(test.GetGlobalBackUrl(), "https://ecuamaps.app", ());
}
...
UNIT_TEST(SearchApiSmoke)
{
  ...
  TEST_EQUAL(test.GetAppName(), "ECUAMAPS", ());
