...
"""
First lists tags used by ECUAMAPS
Then, popular tags among selected keys (see find_popular_taginfo for list) which are not yet used by ECUAMAPS are listed
"""
