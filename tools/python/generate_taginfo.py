...
BASE_ICON_URL: str = "https://raw.githubusercontent.com/ecuamaps/ecuamaps/master/data/styles/default/light/symbols/"

PROJECT_INFO: dict[str, str] = {
    "name": "ECUAMAPS",
    "description": "Free Android & iOS offline maps app for travelers, tourists, hikers, and cyclists",
    "project_url": "https://ecuamaps.app",
    "doc_url": "https://github.com/ecuamaps/ecuamaps",
    "icon_url": "https://ecuamaps.app/logos/green-on-transparent.svg",
    "contact_name": "ECUAMAPS",
    "contact_email": "hello@ecuamaps.app"
}
...
def main() -> None:
    ...
    data: dict[str, any] = {
        "data_format": 1,
        "data_url": "https://raw.githubusercontent.com/ecuamaps/ecuamaps/master/data/taginfo.json",
