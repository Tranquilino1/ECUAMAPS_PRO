...
int main(int argc, char * argv[])
{
  ...
  LOG(LINFO, ("ECUAMAPS", platform.Version(), "built with QT:", QT_VERSION_STR, "runtime QT:", qVersion(),
  ...
  app.setDesktopFileName("app.ecuamaps.desktop");

#ifdef BUILD_DESIGNER
  QApplication::setApplicationName("ECUAMAPS Designer");
#else
  QApplication::setApplicationName("ECUAMAPS");
#endif
  ...
  LOG_SHORT(LINFO, ("ECUAMAPS finished with code", returnCode));
  return returnCode;
}
