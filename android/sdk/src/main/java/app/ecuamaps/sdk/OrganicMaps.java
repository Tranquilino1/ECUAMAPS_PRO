...
import app.ecuamaps.sdk.downloader.Android7RootCertificateWorkaround;
...
import app.ecuamaps.sdk.maplayer.traffic.TrafficManager;
import app.ecuamaps.sdk.routing.RoutingController;
import app.ecuamaps.sdk.search.SearchEngine;
import app.ecuamaps.sdk.settings.StoragePathManager;
import app.ecuamaps.sdk.sound.TtsPlayer;
import app.ecuamaps.sdk.util.Config;
import app.ecuamaps.sdk.util.ConnectionState;
import app.ecuamaps.sdk.util.SharedPropertiesUtils;
import app.ecuamaps.sdk.util.StorageUtils;
import app.ecuamaps.sdk.util.log.Logger;
import app.ecuamaps.sdk.util.log.LogsManager;
import java.io.IOException;

public final class ecuamaps implements DefaultLifecycleObserver
{
  private static final String TAG = ecuamaps.class.getSimpleName();
  ...
  public ecuamaps(@NonNull Context context, @NonNull String flavor, @NonNull String applicationId, int versionCode,
