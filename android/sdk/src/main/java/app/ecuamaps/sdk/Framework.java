...
import app.ecuamaps.sdk.api.ParsedRoutingData;
...
import app.ecuamaps.sdk.products.ProductsConfig;
import app.ecuamaps.sdk.routing.JunctionInfo;
import app.ecuamaps.sdk.routing.RouteMarkData;
import app.ecuamaps.sdk.routing.RouteMarkType;
import app.ecuamaps.sdk.routing.RoutingInfo;
import app.ecuamaps.sdk.routing.RoutingListener;
import app.ecuamaps.sdk.routing.RoutingLoadPointsListener;
import app.ecuamaps.sdk.routing.RoutingProgressListener;
import app.ecuamaps.sdk.routing.RoutingRecommendationListener;
import app.ecuamaps.sdk.routing.TransitRouteInfo;
import app.ecuamaps.sdk.settings.SpeedCameraMode;
...
public class Framework
{
  ...
  @Nullable
  public static native app.ecuamaps.sdk.routing.RouteAltitudeData nativeGetRouteAltitudeData();
