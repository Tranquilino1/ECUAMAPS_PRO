...
#include "app/ecuamaps/sdk/bookmarks/data/Icon.hpp"
#include "app/ecuamaps/sdk/bookmarks/data/PredefinedColors.hpp"
...
JNIEXPORT jint JNI_OnLoad(JavaVM * jvm, void *)
{
  ...
  g_mapObjectClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/bookmarks/data/MapObject");
  g_trackClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/bookmarks/data/Track");
  g_trackStatisticsClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/bookmarks/data/TrackStatistics");
  g_bookmarkClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/bookmarks/data/Bookmark");
  g_httpClientClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/HttpClient");
  g_httpParamsClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/HttpClient$Params");
  g_platformSocketClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/location/PlatformSocket");
  g_utilsClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/Utils");
  g_loggerClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/log/Logger");
  g_keyValueClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/KeyValue");
  g_networkPolicyClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/NetworkPolicy");
  g_elevationInfoClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/bookmarks/data/ElevationInfo");
  g_uiThreadClazz = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/concurrency/UiThread");
...
// https://github.com/ecuamaps/ecuamaps/issues/9397
...
{
  jclass klass = env->FindClass("app/ecuamaps/sdk/bookmarks/data/ParcelablePointD");
  ASSERT(klass, ());
