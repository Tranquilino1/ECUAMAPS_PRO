...
#include "app/ecuamaps/sdk/routing/CarDirection.hpp"
#include "app/ecuamaps/sdk/routing/LaneInfo.hpp"
#include "app/ecuamaps/sdk/routing/PedestrianDirection.hpp"
#include "app/ecuamaps/sdk/routing/roadshield/RoadShieldInfo.hpp"

#include "map/routing_manager.hpp"

jobject CreateRoutingInfo(JNIEnv * env, routing::FollowingInfo const & info, RoutingManager & rm)
{
  static jclass const klass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/routing/RoutingInfo");
  // clang-format off
  static jmethodID const ctorRouteInfoID = jni::GetConstructorID(env, klass,
    "("
    "Lapp/ecuamaps/sdk/util/Distance;"                      // distToTarget
    "Lapp/ecuamaps/sdk/util/Distance;"                      // distToTurn
    "Ljava/lang/String;"                                       // currentStreet
    "Ljava/lang/String;"                                       // nextStreet
    "Lapp/ecuamaps/sdk/routing/roadshield/RoadShieldInfo;"  // nextStreetRoadShields
    "Ljava/lang/String;"                                       // nextNextStreet
    "Lapp/ecuamaps/sdk/routing/roadshield/RoadShieldInfo;"  // nextNextStreetRoadShields
    "D"                                                        // completionPercent
    "Lapp/ecuamaps/sdk/routing/CarDirection;"               // carTurnDirection
    "Lapp/ecuamaps/sdk/routing/CarDirection;"               // carNextTurnDirection
    "Lapp/ecuamaps/sdk/routing/PedestrianDirection;"        // pedestrianDirection
    "I"                                                        // exitNum
    "I"                                                        // totalTime
    "[Lapp/ecuamaps/sdk/routing/LaneInfo;"                  // lanes
    "D"                                                        // speedLimitMps
