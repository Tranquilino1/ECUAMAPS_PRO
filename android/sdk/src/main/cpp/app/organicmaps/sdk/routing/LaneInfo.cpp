...
{
  static jclass const laneWayClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/routing/LaneWay");
  jfieldID fieldID =
      env->GetStaticFieldID(laneWayClass, DebugPrint(laneWay).c_str(), "Lapp/ecuamaps/sdk/routing/LaneWay;");
...
jobjectArray CreateLanesInfo(JNIEnv * env, routing::turns::lanes::LanesInfo const & lanes)
{
  ...
  static jclass const laneWayClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/routing/LaneWay");
  static jclass const laneInfoClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/routing/LaneInfo");
  ...
  static jmethodID const ctorLaneInfoID = jni::GetConstructorID(
      env, laneInfoClass, "([Lapp/ecuamaps/sdk/routing/LaneWay;Lapp/ecuamaps/sdk/routing/LaneWay;)V");
