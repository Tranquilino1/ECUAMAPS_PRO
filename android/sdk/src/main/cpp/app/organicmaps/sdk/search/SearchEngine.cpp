...
extern "C"
{
JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeInit(JNIEnv * env, jobject thiz)
{
  g_javaListener = env->NewGlobalRef(thiz);
  // public void onResultsUpdate(@NonNull SearchResult[] results, long timestamp)
  g_updateResultsId =
      jni::GetMethodID(env, g_javaListener, "onResultsUpdate", "([Lapp/ecuamaps/sdk/search/SearchResult;J)V");
  // public void onResultsEnd(long timestamp)
  g_endResultsId = jni::GetMethodID(env, g_javaListener, "onResultsEnd", "(J)V");
  g_resultClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/search/SearchResult");
  g_resultConstructor =
      jni::GetConstructorID(env, g_resultClass,
                            "(Ljava/lang/String;Lapp/ecuamaps/sdk/search/SearchResult$Description;DD[I[I"
                            "Lapp/ecuamaps/sdk/search/Popularity;)V");
  g_suggestConstructor = jni::GetConstructorID(env, g_resultClass, "(Ljava/lang/String;Ljava/lang/String;DD[I[I)V");
  g_descriptionClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/search/SearchResult$Description");
  /*
  ...
  */
  g_descriptionConstructor =
      jni::GetConstructorID(env, g_descriptionClass,
                            "(Ljava/lang/String;Ljava/lang/String;Lapp/ecuamaps/sdk/util/Distance;"
                            "Ljava/lang/String;IIIZ)V");

  g_popularityClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/search/Popularity");
  ...
  g_mapResultsMethod = jni::GetMethodID(env, g_javaListener, "onMapSearchResults",
                                        "([Lapp/ecuamaps/sdk/search/MapSearchListener$Result;JZ)V");
  g_mapResultClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/search/MapSearchListener$Result");
...
JNIEXPORT jboolean Java_app_ecuamaps_sdk_search_SearchEngine_nativeRunSearch(JNIEnv * env, jclass clazz,
...
JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeRunInteractiveSearch(
...
JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeRunSearchMaps(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_ecuamaps_sdk_search_SearchEngine_nativeRunSearchInBookmarks(JNIEnv * env, jclass clazz,
                                                                                           jbyteArray query,
...
JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeShowResult(JNIEnv * env, jclass clazz, jint index)
{
  g_framework->NativeFramework()->ShowSearchResult(g_results[index]);
}

JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeCancelInteractiveSearch(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Viewport);
}

JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeCancelEverywhereSearch(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Everywhere);
}

JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeCancelAllSearches(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelAllSearches();
}

JNIEXPORT void Java_app_ecuamaps_sdk_search_SearchEngine_nativeUpdateViewportWithLastResults(JNIEnv * env,
                                                                                                jclass clazz)
{
