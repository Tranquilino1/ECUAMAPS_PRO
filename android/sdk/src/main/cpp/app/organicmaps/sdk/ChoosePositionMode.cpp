...
extern "C"
{
JNIEXPORT void Java_app_ecuamaps_sdk_ChoosePositionMode_nativeSet(JNIEnv *, jclass, jint mode, jboolean isBusiness,
...
JNIEXPORT jint Java_app_ecuamaps_sdk_ChoosePositionMode_nativeGet(JNIEnv *, jclass)
{
