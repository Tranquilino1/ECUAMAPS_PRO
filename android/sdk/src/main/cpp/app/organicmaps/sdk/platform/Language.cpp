#include "android/sdk/src/main/cpp/app/ecuamaps/sdk/core/ScopedLocalRef.hpp"
...
std::string GetAndroidSystemLanguage()
{
  ...
  static jclass const languageClass = jni::GetGlobalClassRef(env, "app/ecuamaps/sdk/util/Language");
