package app.ecuamaps.car.screens.permissions;
...
public class RequestPermissionsScreenBuilder
{
  ...
  @NonNull
  public static Screen build(@NonNull CarContext carContext, @NonNull ecuamaps ecuamapsContext,
                             @NonNull Runnable permissionsGrantedCallback)
  {
        ...
        && ContextCompat.checkSelfPermission(carContext, POST_NOTIFICATIONS) != PERMISSION_GRANTED)
    {
      ...
      return new RequestPermissionsScreenWithApi(carContext, ecuamapsContext, permissionsGrantedCallback);
    }
    return new RequestPermissionsScreenWithNotification(carContext, ecuamapsContext, permissionsGrantedCallback);
  }
}
