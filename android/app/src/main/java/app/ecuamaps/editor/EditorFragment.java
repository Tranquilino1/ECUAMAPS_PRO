...
import app.ecuamaps.editor.data.TimeFormatUtils;
import app.ecuamaps.sdk.Framework;
import app.ecuamaps.sdk.bookmarks.data.Metadata;
import app.ecuamaps.sdk.editor.Editor;
import app.ecuamaps.sdk.editor.OpeningHours;
import app.ecuamaps.sdk.editor.data.LocalizedName;
import app.ecuamaps.sdk.editor.data.LocalizedStreet;
import app.ecuamaps.sdk.editor.data.Timetable;
import app.ecuamaps.sdk.util.StringUtils;
import app.ecuamaps.sdk.util.Utils;
import app.ecuamaps.util.Graphics;
...
public class EditorFragment extends BaseMwmFragment implements View.OnClickListener
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    // TODO Reimplement this to avoid https://github.com/ecuamaps/ecuamaps/issues/9049
