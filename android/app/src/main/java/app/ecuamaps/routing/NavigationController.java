...
import app.ecuamaps.sdk.widget.roadshield.RoadShieldUtils;
import app.ecuamaps.sdk.widgets.lanes.LanesView;
import app.ecuamaps.sdk.widgets.speedlimit.SpeedLimitView;
...
import app.ecuamaps.widget.menu.NavMenu;
...
public class NavigationController implements TrafficManager.TrafficCallback, NavMenu.NavMenuListener
{
  ...
  private void updateStreetView(@NonNull RoutingInfo info)
  {
    ...
    // https://github.com/ecuamaps/ecuamaps/issues/3732
