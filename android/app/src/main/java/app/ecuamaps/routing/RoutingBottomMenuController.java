...
import app.ecuamaps.sdk.routing.RouteAltitudeData;
...
import app.ecuamaps.sdk.routing.TransitStepInfo;
...
import app.ecuamaps.widget.recycler.DotDividerItemDecoration;
import app.ecuamaps.widget.recycler.MultilineLayoutManager;
  ...
  void setStartButton(boolean show)
  {
    if (show)
    {
      ...
      mStart.setOnClickListener(v -> {
        ...
        // https://github.com/ecuamaps/ecuamaps/issues/6628
