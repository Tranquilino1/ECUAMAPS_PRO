...
import static app.ecuamaps.sdk.location.LocationState.FOLLOW;
import static app.ecuamaps.sdk.location.LocationState.FOLLOW_AND_ROTATE;
import static app.ecuamaps.sdk.location.LocationState.LOCATION_TAG;
import static app.ecuamaps.sdk.util.PowerManagment.POWER_MANAGEMENT_TAG;
import static app.ecuamaps.sdk.util.Utils.dimen;
...
import app.ecuamaps.base.OnBackPressListener;
import app.ecuamaps.bookmarks.BookmarkCategoriesActivity;
import app.ecuamaps.downloader.DownloaderActivity;
import app.ecuamaps.downloader.DownloaderFragment;
import app.ecuamaps.downloader.OnmapDownloader;
import app.ecuamaps.editor.EditorActivity;
import app.ecuamaps.editor.EditorHostFragment;
import app.ecuamaps.editor.FeatureCategoryActivity;
import app.ecuamaps.editor.OsmLoginActivity;
import app.ecuamaps.editor.ReportFragment;
import app.ecuamaps.help.HelpActivity;
import app.ecuamaps.intent.Factory;
import app.ecuamaps.intent.IntentProcessor;
import app.ecuamaps.location.TrackRecordingService;
import app.ecuamaps.maplayer.MapButtonsController;
import app.ecuamaps.maplayer.MapButtonsViewModel;
import app.ecuamaps.maplayer.ToggleMapLayerFragment;
import app.ecuamaps.routing.ManageRouteBottomSheet;
import app.ecuamaps.routing.NavigationController;
import app.ecuamaps.routing.NavigationService;
import app.ecuamaps.routing.RoutingBottomMenuListener;
import app.ecuamaps.routing.RoutingErrorDialogFragment;
import app.ecuamaps.routing.RoutingPlanFragment;
import app.ecuamaps.routing.RoutingPlanInplaceController;
import app.ecuamaps.sdk.ChoosePositionMode;
import app.ecuamaps.sdk.Framework;
import app.ecuamaps.sdk.Map;
import app.ecuamaps.sdk.MapController;
import app.ecuamaps.sdk.MapRenderingListener;
import app.ecuamaps.sdk.PlacePageActivationListener;
import app.ecuamaps.sdk.Router;
import app.ecuamaps.sdk.bookmarks.data.BookmarkManager;
import app.ecuamaps.sdk.bookmarks.data.MapObject;
import app.ecuamaps.sdk.bookmarks.data.TrackRecording;
...
import app.ecuamaps.sdk.downloader.UpdateInfo;
...
import app.ecuamaps.sdk.location.LocationListener;
import app.ecuamaps.sdk.location.LocationState;
import app.ecuamaps.sdk.location.LocationUtils;
import app.ecuamaps.sdk.location.SensorListener;
import app.ecuamaps.sdk.location.TrackRecorder;
import app.ecuamaps.sdk.maplayer.isolines.IsolinesState;
import app.ecuamaps.sdk.routing.RouteMarkType;
import app.ecuamaps.sdk.routing.RoutingController;
import app.ecuamaps.sdk.routing.RoutingOptions;
import app.ecuamaps.sdk.search.SearchEngine;
import app.ecuamaps.sdk.settings.RoadType;
import app.ecuamaps.sdk.settings.UnitLocale;
import app.ecuamaps.sdk.util.Config;
import app.ecuamaps.sdk.util.PowerManagment;
import app.ecuamaps.sdk.util.StringUtils;
import app.ecuamaps.sdk.util.log.Logger;
import app.ecuamaps.sdk.widget.placepage.PlacePageData;
import app.ecuamaps.search.FloatingSearchToolbarController;
import app.ecuamaps.search.SearchActivity;
import app.ecuamaps.search.SearchFragment;
import app.ecuamaps.settings.DrivingOptionsActivity;
import app.ecuamaps.settings.SettingsActivity;
import app.ecuamaps.util.SharingUtils;
import app.ecuamaps.util.ThemeSwitcher;
import app.ecuamaps.util.ThemeUtils;
import app.ecuamaps.util.UiUtils;
import app.ecuamaps.util.Utils;
import app.ecuamaps.util.WindowInsetUtils.BaselinePaddingInsetsListener;
import app.ecuamaps.util.bottomsheet.MenuBottomSheetFragment;
import app.ecuamaps.util.bottomsheet.MenuBottomSheetItem;
import app.ecuamaps.widget.menu.MainMenu;
import app.ecuamaps.widget.placepage.PlacePageController;
import app.ecuamaps.widget.placepage.PlacePageViewModel;
               ...
               MapButtonsController.MapButtonClickListener, DisplayChangedListener
{
  ...
  protected void onSafeCreate(@Nullable Bundle savedInstanceState)
  {
     ...
     * https://github.com/ecuamaps/ecuamaps/issues/6712
     */
    if (Map.isEngineCreated())
  ...
  public void onSwitchFullScreenMode()
  {
    ...
    if (isFullscreen())
    {
      ...
      // TODO(pastk): there are better solutions, see https://github.com/ecuamaps/ecuamaps/issues/9344
