...
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_DISK_ERROR;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_DOWNLOAD_ERROR;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_DOWNLOAD_SUCCESS;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_NOT_ENOUGH_FREE_SPACE;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_NO_MORE_FILES;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.ERR_STORAGE_DISCONNECTED;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.nativeCancelCurrentFile;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.nativeGetBytesToDownload;
import static app.ecuamaps.sdk.DownloadResourcesLegacyActivity.nativeStartNextFileDownload;
...
import app.ecuamaps.sdk.util.ConnectionState;
import app.ecuamaps.sdk.util.StringUtils;
import app.ecuamaps.util.UiUtils;
import app.ecuamaps.util.Utils;
import app.ecuamaps.util.WindowInsetUtils.PaddingInsetsListener;
...
public class DownloadResourcesLegacyActivity extends BaseMwmFragmentActivity
{
  ...
  private final app.ecuamaps.sdk.DownloadResourcesLegacyActivity.Listener mResourcesDownloadListener =
      new app.ecuamaps.sdk.DownloadResourcesLegacyActivity.Listener() {
        @Override
  ...
  public void showMap()
  {
    ...
    // https://github.com/ecuamaps/ecuamaps/issues/6944
