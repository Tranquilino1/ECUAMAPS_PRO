...
import app.ecuamaps.widget.placepage.WikiArticleActivity;
...
public class PlacePageWikipediaFragment extends Fragment implements Observer<MapObject>
{
  ...
  {
    // There are two sources of wiki info in ecuamaps:
    // wiki links from OpenStreetMaps, and wiki pages explicitly parsed into ecuamaps.
