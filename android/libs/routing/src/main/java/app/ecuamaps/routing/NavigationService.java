...
import static app.ecuamaps.sdk.util.Constants.Vendor.XIAOMI;
...
import app.ecuamaps.sdk.routing.RoutingInfo;
import app.ecuamaps.sdk.sound.MediaPlayerWrapper;
import app.ecuamaps.sdk.sound.TtsPlayer;
import app.ecuamaps.sdk.util.Assert;
import app.ecuamaps.sdk.util.Config;
import app.ecuamaps.sdk.util.Graphics;
...
public class NavigationService extends Service implements LocationListener
{
  ...
  private static ecuamaps secuamaps;
  @Nullable
  ...
  public static void setecuamaps(@NonNull ecuamaps ecuamaps)
  {
    secuamaps = ecuamaps;
  }
  ...
  public static NotificationCompat.Builder getNotificationBuilder(@NonNull Context context)
  {
    ...
    mNotificationBuilder = new NotificationCompat.Builder(appContext, CHANNEL_ID)
                               ...
                               .setSmallIcon(app.ecuamaps.branding.R.drawable.ic_splash)
  ...
  {
    Logger.i(TAG);
    Assert.always(secuamaps != null, "ecuamaps instance must be set before starting NavigationService");
  ...
  public void onDestroy()
  {
    ...
    secuamaps.getLocationHelper().removeListener(this);
  ...
  public int onStartCommand(@NonNull Intent intent, int flags, int startId)
  {
    ...
    if (!secuamaps.arePlatformAndCoreInitialized())
    {
      ...
      // https://github.com/ecuamaps/ecuamaps/issues/6233
    ...
    final LocationHelper locationHelper = secuamaps.getLocationHelper();
  ...
  public void onLocationUpdated(@NonNull Location location)
  {
    ...
    // the core to the platform code (https://github.com/ecuamaps/ecuamaps/issues/3589),
    ...
    if (Framework.nativeIsRouteFinished())
    {
      ...
      secuamaps.getLocationHelper().restartWithNewMode();
      stopSelf();
      return;
    }
      ...
      if (drawable != null)
      {
        mLastTurnBitmap = isColorizedSupported()
                            ...
                            : Graphics.drawableToBitmapWithTint(
                                  drawable, ContextCompat.getColor(this, app.ecuamaps.branding.R.color.base_accent));
