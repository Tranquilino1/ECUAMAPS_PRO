...
import app.ecuamaps.car.screens.settings.DrivingOptionsScreen;
import app.ecuamaps.car.util.Colors;
import app.ecuamaps.car.util.UiHelpers;
import app.ecuamaps.routing.ResultCodesHelper;
...
import app.ecuamaps.sdk.car.OnBackPressedCallback;
import app.ecuamaps.sdk.car.RoutingHelpers;
...
public class PlaceScreen extends BaseMapScreen implements OnBackPressedCallback.Callback, RoutingController.Container
{
  ...
  {
    super(builder.mCarContext, builder.mecuamapsContext, builder.mSurfaceRenderer);
        ...
        .setOnClickListener(
            ()
                -> getScreenManager().pushForResult(
                    new DrivingOptionsScreen(getCarContext(), getecuamapsContext(), getSurfaceRenderer()),
  ...
  public void showNavigation(boolean show)
  {
    if (show)
    {
      ...
      getScreenManager().push(
          new NavigationScreen.Builder(getCarContext(), getecuamapsContext(), getSurfaceRenderer())
  ...
  public void onCommonBuildError(int lastResultCode, @NonNull String[] lastMissingMaps)
  {
    if (ResultCodesHelper.isDownloadable(lastResultCode, lastMissingMaps.length))
      getScreenManager().pushForResult(
          new DownloadMapsScreenBuilder(getCarContext(), getecuamapsContext())
  ...
  public static final class Builder
  {
    ...
    public Builder(@NonNull final CarContext carContext, @NonNull ecuamaps ecuamapsContext,
