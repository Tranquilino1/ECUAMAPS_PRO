...
public class DownloadMapsScreenBuilder
{
  ...
  @NonNull
  final ecuamaps mecuamapsContext;
  ...
  public DownloadMapsScreenBuilder(@NonNull CarContext carContext, @NonNull ecuamaps ecuamapsContext)
  {
  ...
  public DownloadMapsScreen build()
  {
    ...
    return switch (mDownloaderType)
    {
      ...
      case BuildRoute -> new app.ecuamaps.car.screens.download.DownloadMapsForRouteScreen(this);
