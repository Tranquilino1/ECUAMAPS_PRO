package app.ecuamaps.car.screens.search;
...
import app.ecuamaps.sdk.search.SearchListener;
import app.ecuamaps.sdk.search.SearchRecents;
import app.ecuamaps.sdk.search.SearchResult;
import app.ecuamaps.sdk.util.Language;
...
public class SearchOnMapScreen extends BaseMapScreen implements SearchListener
{
  ...
  private Row createResultItem(@NonNull SearchResult result, int resultIndex)
  {
    ...
    else
    {
      ...
      builder.setOnClickListener(
          ()
              -> getScreenManager().push(new Builder(getCarContext(), getecuamapsContext(), getSurfaceRenderer())
  ...
  public static final class Builder
  {
    ...
    public Builder(@NonNull CarContext carContext, @NonNull ecuamaps ecuamapsContext,
