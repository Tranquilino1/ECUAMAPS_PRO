...
public class SettingsScreen extends BaseMapScreen
{
  ...
  public SettingsScreen(@NonNull CarContext carContext, @NonNull ecuamaps ecuamapsContext,
  ...
  private Item createThemeItem()
  {
    ...
    builder.setOnClickListener(
        () -> getScreenManager().push(new ThemeScreen(getCarContext(), getecuamapsContext(), getSurfaceRenderer())));
  ...
  private Item createHelpItem()
  {
    ...
    builder.setOnClickListener(
        () -> getScreenManager().push(new HelpScreen(getCarContext(), getecuamapsContext(), getSurfaceRenderer())));
    builder.setBrowsable(true);
    return builder.build();
  }
