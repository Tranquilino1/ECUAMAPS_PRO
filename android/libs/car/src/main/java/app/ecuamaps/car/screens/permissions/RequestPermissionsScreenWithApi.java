...
public class RequestPermissionsScreenWithApi extends BaseScreen implements UserActionRequired
{
  ...
  public RequestPermissionsScreenWithApi(@NonNull CarContext carContext, @NonNull ecuamaps ecuamapsContext,
                                          ...
                                          @NonNull List<String> rejectedPermissions)
  {
    ...
    {
      getScreenManager().push(new ErrorScreen.Builder(getCarContext(), getecuamapsContext())
