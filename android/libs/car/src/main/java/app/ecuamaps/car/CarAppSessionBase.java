...
import app.ecuamaps.car.screens.PlaceScreen;
import app.ecuamaps.car.screens.download.DownloadMapsScreen;
import app.ecuamaps.car.util.CurrentCountryChangedListener;
import app.ecuamaps.car.util.ThemeUtils;
...
import app.ecuamaps.sdk.car.CarSensorsManager;
import app.ecuamaps.sdk.car.renderer.Renderer;
import app.ecuamaps.sdk.car.renderer.RendererFactory;
    ...
    extends Session implements DefaultLifecycleObserver, LocationState.ModeChangeListener, PlacePageActivationListener
{
  ...
  @NonNull
  protected final ecuamaps mecuamapsContext;
  @Nullable
  ...
  public CarAppSessionBase(@NonNull ecuamaps ecuamapsContext, @Nullable SessionInfo sessionInfo, boolean isDebug)
  {
  ...
  public void onCreate(@NonNull LifecycleOwner owner)
  {
    Logger.d(TAG);
    mSurfaceRenderer =
        RendererFactory.create(getCarContext(), mDisplayManager, mecuamapsContext.getLocationHelper(), owner);
    mSensorsManager = new CarSensorsManager(getCarContext(), mecuamapsContext.getSensorHelper(),
                                            mecuamapsContext.getLocationHelper());
  }
  ...
  public void onStart(@NonNull LifecycleOwner owner)
  {
    ...
    if (isCarScreenUsed())
    {
      ...
      mCurrentCountryChangedListener.onStart(getCarContext(), mecuamapsContext);
    }
  ...
  public void onPlacePageActivated(@NonNull PlacePageData data)
  {
    ...
    final PlaceScreen placeScreen = new PlaceScreen.Builder(getCarContext(), mecuamapsContext, mSurfaceRenderer)
