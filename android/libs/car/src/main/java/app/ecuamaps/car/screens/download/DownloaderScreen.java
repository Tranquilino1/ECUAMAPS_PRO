package app.ecuamaps.car.screens.download;
...
import app.ecuamaps.downloader.ErrorCodeHelper;
...
class DownloaderScreen extends BaseScreen
{
  ...
  DownloaderScreen(@NonNull final CarContext carContext, @NonNull ecuamaps ecuamapsContext,
  ...
  private void onError(@NonNull final MapManager.StorageCallbackData data)
  {
    ...
    final ErrorScreen.Builder builder = new ErrorScreen.Builder(getCarContext(), getecuamapsContext())
