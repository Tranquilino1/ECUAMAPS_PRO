...
## JNI bridge pattern
Java native methods in `Framework.java` / `ecuamaps.java` map to C++ in `sdk/src/main/cpp/`:
```java
// Java side (sdk/src/main/java/app/ecuamaps/sdk/Framework.java):
...
// JNI helpers: sdk/src/main/cpp/app/ecuamaps/sdk/core/jni_helper.hpp
```
...
- `ecuamaps.java` -- SDK initialization and platform setup
